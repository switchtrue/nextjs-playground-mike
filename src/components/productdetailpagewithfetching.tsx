...
import { CustomerReviewsWithFetching } from "./customerreviewswithfetching";
import { RecommendationsWithFetching } from "./recommendationswithfetching";

export function ProductDetailPageWithfetching() {
  return (
    <div className="bg-background text-foreground">
      <div className="container mx-auto px-4 md:px-6 py-8 md:py-12">
        ...
        <div className="mt-12 md:mt-16">
          ...
          <RecommendationsWithFetching />
        </div>
        <div className="mt-12 md:mt-16">
          <h2 className="text-2xl md:text-3xl font-bold mb-6">
            Customer Reviews
          </h2>
          <CustomerReviewsWithFetching />
        </div>
      </div>
    </div>
  );
