...
import {
  RecommendationsForSuspenseServer,
  RecommendationsSkeletonForSuspenseServer,
} from "./recommendationsforsuspenseserver";
import {
  CustomerReviewsForSuspenseServer,
  CustomerReviewsSkeletonForSuspenseServer,
} from "./customerreviewsforsuspenseserver";
    ...
    <div className="bg-background text-foreground">
      <div className="container mx-auto px-4 md:px-6 py-8 md:py-12">
        ...
        <div className="mt-12 md:mt-16">
          ...
          <Suspense fallback={<RecommendationsForSuspenseServer />}>
            <RecommendationsSkeletonForSuspenseServer />
          </Suspense>
        </div>
        <div className="mt-12 md:mt-16">
          ...
          <Suspense fallback={<CustomerReviewsSkeletonForSuspenseServer />}>
            <CustomerReviewsForSuspenseServer />
          </Suspense>
        </div>
      </div>
